...
-   [aula-2-rmarkdown.Rmd](https://github.com/beatrizmilz/2023-curso-de-verao-ime-usp-relatorios/blob/main/pratica/aula-2-rmarkdown.Rmd) - experimentando algumas funcionalidades de relatório. 
...
- Slide 7 - Introdução ao Git e GitHub no RStudio (em breve)
