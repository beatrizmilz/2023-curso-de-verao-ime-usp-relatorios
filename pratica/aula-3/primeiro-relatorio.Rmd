...
```{r, out.width="80%", fig.align="center", dpi = 300, fig.cap="Gráfico de quantidade de pinguins por espécie", fig.alt="A imagem apresenta um gráfico de barras onde temos no eixo x a quantidade de pinguins, e no eixo y as espécies de pinguins. A espécie com mais pinguins na base é Pinguin de adélia."}
library(ggplot2)
pinguins |> 
  dplyr::count(especie) |> 
  ggplot() +
...
#| fig-align: "center"
#| dpi: 300
#| fig-cap: "Gráfico de quantidade de pinguins por espécie"
#| fig-alt: "A imagem apresenta um gráfico de barras onde temos no eixo x a quantidade de pinguins, e no eixo y as espécies de pinguins. A espécie com mais pinguins na base é Pinguin de adélia."
#| 
